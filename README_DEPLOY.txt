...
STREAMLIT CLOUD FIX
-------------------
This package removes the direct pyarrow dependency and writes generated profile caches as CSV.
It also requests Python 3.12 through runtime.txt and .python-version for broader wheel compatibility.
Deploy app.py as the main file. Upload every extracted file and folder to the repository root.
